...
describe("Test rule: multi", () => {
		...
		it("issue #297", () => {
			...
			expect(
				...
				},
				{
					type: "objectStrict",
					message:
						"The object '' contains forbidden keys: 'address'.",
					expected: "age, name, surname",
					actual: "address",
				},
			]);
		});
	...
	describe("should work with custom validator", () => {
		...
		it("test strOK", () => {
			...
			{
				const o = { a: "not-OK" };
				expect(check(o)).toStrictEqual([
					{ field: "a", message: undefined, type: "strOK" },
					{
						actual: "not-OK",
						field: "a",
					...
					{ field: "a", message: undefined, type: "num99" },
				]);
